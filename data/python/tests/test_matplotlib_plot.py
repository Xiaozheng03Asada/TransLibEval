import unittest
from function_matplotlib_plot import BarPlotGenerator

class TestMatplotlibPlot(unittest.TestCase):
    ...
    def test_non_numeric_values(self):
        result = BarPlotGenerator.create_bar_plot("A,B,C", "10,'20',30")
        self.assertEqual(result, "Error: All values must be numbers.")
