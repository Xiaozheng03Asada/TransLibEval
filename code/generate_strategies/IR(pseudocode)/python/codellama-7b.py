...
# 定义输入文件夹路径和输出文件夹
input_folder = "CodeLlama7b_python_sum"  # 包含功能梗概的文件夹
...
def generate_code_with_meta_llama(summary, language, retries=5):
    ...
    for attempt in range(retries):
        try:
            # 调用 Qianfan API 使用 CodeLlama7b 模型
            response = comp.do(
                model="CodeLlama7b",
                prompt=prompt,
                temperature=0.01,
