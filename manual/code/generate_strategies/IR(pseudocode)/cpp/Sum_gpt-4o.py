...
output_folder = "GPT4o_cpp_sum"  # 生成的文本文件将保存在该文件夹
...
# 修改后的 API 调用函数
def analyze_code_with_gpt4o(source_code, class_name, retries=5):
...
def process_cpp_file(cpp_file):
    ...
    summary = analyze_code_with_gpt4o(source_code, class_name)
